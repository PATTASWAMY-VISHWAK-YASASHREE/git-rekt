...
// Initialize Gemini API (server-side only using environment variable)
...
export async function generateGeminiRoasts(userData, repos, commits, events, analysisResults) {
  // Initialize Gemini with server-managed environment variable only
